            ...
            if gui.is_counter_selected():
                ...
                try:
                    ...
                    # keylogger is disabled until esc is pressed again
                        ...
                        if gui.is_disabled() and gui.is_in_focus():
                            gui.unpause_run_time()
                            gui.enable()
                        else:
                            gui.disable()
...
def on_release(event, queue1):
    ...
    if gui.is_counter_selected():
        ...
        if not gui.is_disabled() or event.scan_code in [1, 9]:
...
for line in counters:
    ...
    if item[0]:
        ...
        counterList.append(UI.cC.Counter(*item))
